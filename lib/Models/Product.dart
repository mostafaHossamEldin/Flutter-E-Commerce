...
class Product {
  ...
  factory Product.fromFirestore(DocumentSnapshot doc) {
    ...
    return Product(
      ...
      avgRating: (data['avgRating'] is int)
          ? (data['avgRating'] as int).toDouble()
          : (data['avgRating'] ?? 0.0),
      ratings: parsedRatings,
      // isTopRated: data['isTopRated'] ?? false,
      isTopRated: (data['avgRating'] is int)
          ? (data['avgRating'] as int).toDouble() >= 4.5
          : (data['avgRating'] ?? 0.0) >= 4.5,
      ...
      discountedPrice: (data['discountedPrice'] is int)
          ? (data['discountedPrice'] as int).toDouble()
          : (data['discountedPrice'] ?? 0.0),
