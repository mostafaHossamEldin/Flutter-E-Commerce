  ...
  if (productIndex >= 0) {
    try {
      ...
      final updatedProduct = Product(
        ...
        isDiscounted: data['isDiscounted'] ?? _products[productIndex].isDiscounted,
        discountPercentage: data['discountPercentage'] ?? _products[productIndex].discountPercentage,
        discountedPrice: data.containsKey('discountPercentage') 
                          ? (data['price'] ?? _products[productIndex].price) - ((data['price'] ?? _products[productIndex].price) * data['discountPercentage'] / 100) 
                          : _products[productIndex].discountedPrice,
        description: data['description'] ?? _products[productIndex].description,
      );
